...
namespace AppCode
{
    ...
    public class Dal
    {
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = DALayerParameterCache.GetSpParameterSet(connectionString, spName);
        ...
        // param name="connectionString" a valid connection string for a SqlConnection 
        // param name="commandType" the CommandType (stored procedure, text, etc.) 
        // param nam e="commandText" the stored procedure name or T-SQL command 
        // param name="commandParameters" an array of SqlParamters used to execute the command 
        ...
        public DataSet ExecuteSQLQuery(string sqlquery)
        {
            ...
            try
            {
                ...
                SqlConnection MyConnection = new SqlConnection(BLLCommon.conn);
                ...
                SqlDataAdapter dataadp = new SqlDataAdapter(mycommand);
        ...
        public static DataSet ExecutePROC(string sqlquery, SqlParameter[] pramcoll)
        {
            DataSet data = new DataSet();
            try
            {
                ...
                foreach (SqlParameter paramtemp in pramcoll)
                {
    ...
    //*********************************************************************
    //
    // DALayerParameterCache provides functions to leverage a static cache of procedure parameters, and the
    // ability to discover parameters for stored procedures at run-time.
    //
    //*********************************************************************

    public sealed class DALayerParameterCache
    {
        //*********************************************************************
        //
        // Since this class provides only static methods, make the default constructor private to prevent 
        // instances from being created with "new DALayerParameterCache()".
        //
        //*********************************************************************

        private DALayerParameterCache() { }
